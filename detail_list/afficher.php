...
<body>
    ...
    <?php elseif(!isset($stagiaireseul)):?> <!--dans le cas ou il y a un id mais pas de stagiaire ex 2.1 --> 
        <p>"Pas de stagiaire connu avec cet id"</p>
    <?php else: ?> <!--dans le cas ou id existe et que il correspond a un stagiaire -->
        <ul>
            <?php foreach($stagiaireseul['hobbies']as $hobby): ?> <!--on boucles sur les hobit du stagiaires -->
